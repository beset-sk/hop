...
@Transform(
    id = "XMLOutputCustom",
    image = "XOU.svg",
    name = "i18n::XMLOutputCustom.name",
    description = "i18n::XMLOutputCustom.description",
    categoryDescription = "i18n::XMLOutputCustom.category",
    keywords = "i18n::XmlOutputMeta.keyword",
    documentationUrl = "/pipeline/transforms/xmloutput.html")
@InjectionSupported(localizationPrefix = "XMLOutputCustom.Injection.", groups = "OUTPUT_FIELDS")
public class XmlOutputCustomMeta extends BaseTransformMeta<XmlOutputCustom, XmlOutputCustomData> {
  ...
  /** The output fields */
  @InjectionDeep private XmlFieldCustom[] outputFields;
   ...
   */
  public void setOutputFields(XmlFieldCustom[] outputFields) {
    this.outputFields = outputFields;
  }

  public void allocate(int nrFields) {
    outputFields = new XmlFieldCustom[nrFields];
  }

  @Override
  public Object clone() {
    XmlOutputCustomMeta retval = (XmlOutputCustomMeta) super.clone();
    int nrFields = outputFields.length;

    retval.allocate(nrFields);

    for (int i = 0; i < nrFields; i++) {
      retval.outputFields[i] = (XmlFieldCustom) outputFields[i].clone();
    }
  ...
  public void loadXml(Node transformNode, IHopMetadataProvider metadataProvider)
    ...
    try {
      ...
      for (int i = 0; i < nrFields; i++) {
        ...
        outputFields[i] = new XmlFieldCustom();
  ...
  public void getFields(
    ...
    for (int i = 0; i < outputFields.length; i++) {
      XmlFieldCustom field = outputFields[i];
  ...
  public void check(
    ...
    if (prev != null && prev.size() > 0) {
      cr =
          new CheckResult(
              ...
              BaseMessages.getString(
                  PKG, "XMLOutputCustomMeta.CheckResult.FieldsReceived", "" + prev.size()),
              transforminfo);
      remarks.add(cr);
      ...
      if (errorFound) {
        errorMessage =
            BaseMessages.getString(
                PKG, "XMLOutputCustomMeta.CheckResult.FieldsNotFound", errorMessage);
        ...
        cr =
            new CheckResult(
                ICheckResult.TYPE_RESULT_OK,
                BaseMessages.getString(PKG, "XMLOutputCustomMeta.CheckResult.AllFieldsFound"),
                transforminfo);
        remarks.add(cr);
      }
    }
    ...
    if (input.length > 0) {
      cr =
          new CheckResult(
              ICheckResult.TYPE_RESULT_OK,
              BaseMessages.getString(PKG, "XMLOutputCustomMeta.CheckResult.ExpectedInputOk"),
              transforminfo);
      remarks.add(cr);
    } else {
      cr =
          new CheckResult(
              ...
              BaseMessages.getString(PKG, "XMLOutputCustomMeta.CheckResult.ExpectedInputError"),
              transforminfo);
      remarks.add(cr);
    }
    ...
    cr =
        new CheckResult(
            ...
            BaseMessages.getString(PKG, "XMLOutputCustomMeta.CheckResult.FilesNotChecked"),
            transforminfo);
    remarks.add(cr);
  }
