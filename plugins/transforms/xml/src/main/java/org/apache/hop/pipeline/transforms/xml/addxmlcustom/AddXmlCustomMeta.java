...
@Transform(
    id = "AddXMLCustom",
    image = "add_xml.svg",
    name = "i18n::AddXMLCustom.name",
    description = "i18n::AddXMLCustom.description",
    categoryDescription = "i18n::AddXMLCustom.category",
    keywords = "i18n::AddXmlMeta.keyword",
    documentationUrl = "/pipeline/transforms/addxml.html")
@InjectionSupported(
    localizationPrefix = "AddXMLCustomMeta.Injection.",
    groups = {"OUTPUT_FIELDS"})
public class AddXmlCustomMeta extends BaseTransformMeta<AddXmlCustom, AddXmlCustomData> {
  ...
  @Override
  public Object clone() {
    AddXmlCustomMeta retval = (AddXmlCustomMeta) super.clone();
  ...
  public void check(
    ...
    if (prev != null && prev.size() > 0) {
      cr =
          new CheckResult(
              ...
              BaseMessages.getString(
                  PKG, "AddXMLCustomMeta.CheckResult.FieldsReceived", "" + prev.size()),
              transformMeta);
      remarks.add(cr);
      ...
      if (errorFound) {
        errorMessage =
            BaseMessages.getString(
                PKG, "AddXMLCustomMeta.CheckResult.FieldsNotFound", errorMessage);
        ...
        cr =
            new CheckResult(
                ICheckResult.TYPE_RESULT_OK,
                BaseMessages.getString(PKG, "AddXMLCustomMeta.CheckResult.AllFieldsFound"),
                transformMeta);
        remarks.add(cr);
      }
    }
    ...
    if (input.length > 0) {
      cr =
          new CheckResult(
              ICheckResult.TYPE_RESULT_OK,
              BaseMessages.getString(PKG, "AddXMLCustomMeta.CheckResult.ExpectedInputOk"),
              transformMeta);
      remarks.add(cr);
    } else {
      cr =
          new CheckResult(
              ...
              BaseMessages.getString(PKG, "AddXMLCustomMeta.CheckResult.ExpectedInputError"),
              transformMeta);
      remarks.add(cr);
    }
    ...
    cr =
        new CheckResult(
            ...
            BaseMessages.getString(PKG, "AddXMLCustomMeta.CheckResult.FilesNotChecked"),
            transformMeta);
    remarks.add(cr);
  }
