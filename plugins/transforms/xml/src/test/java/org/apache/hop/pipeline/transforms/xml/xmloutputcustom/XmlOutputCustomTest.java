...
public class XmlOutputCustomTest {

  private TransformMockHelper<XmlOutputCustomMeta, XmlOutputCustomData> transformMockHelper;
  private XmlOutputCustom xmlOutput;
  private XmlOutputCustomMeta xmlOutputMeta;
  private XmlOutputCustomData xmlOutputData;
  ...
  public void setup() throws Exception {
    ...
    transformMockHelper =
        new TransformMockHelper<>(
            "XML_OUTPUT_TEST", XmlOutputCustomMeta.class, XmlOutputCustomData.class);
    ...
    xmlOutputMeta = new XmlOutputCustomMeta();
    ...
    xmlOutputData = new XmlOutputCustomData();
  ...
  @Test
  public void testDefaultXmlFieldCustomContentType() {
    XmlFieldCustom[] xmlFields = initOutputFields(4, null);
  ...
  private XmlFieldCustom[] initOutputFields(int i, ContentType attribute) {

    XmlFieldCustom[] fields = new XmlFieldCustom[i];
