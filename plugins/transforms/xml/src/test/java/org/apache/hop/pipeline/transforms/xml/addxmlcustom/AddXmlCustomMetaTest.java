...
public class AddXmlCustomMetaTest {
  ...
  public void loadSaveTest() throws HopException {
    ...
    fieldLoadSaveValidatorTypeMap.put(
        XmlFieldCustom[].class.getCanonicalName(),
        new ArrayLoadSaveValidator<>(new XMLFieldLoadSaveValidator(xmlField), 1));

    //    TransformLoadSaveTester tester = new TransformLoadSaveTester( AddXmlCustomMeta.class,
  ...
  public static class XMLFieldLoadSaveValidator implements IFieldLoadSaveValidator<XmlFieldCustom> {

    private final XmlFieldCustom defaultValue;

    public XMLFieldLoadSaveValidator(XmlFieldCustom defaultValue) {
      this.defaultValue = defaultValue;
    }

    @Override
    public XmlFieldCustom getTestObject() {
      return defaultValue;
    }

    @Override
    public boolean validateTestObject(XmlFieldCustom testObject, Object actual) {
