...
public class XmlOutputCustomMetaTest {
  ...
  public void testLoadAndGetXml() throws Exception {
    ...
    assertXmlOutputCustomMeta(xmlOutputMeta);
  }

  private void assertXmlOutputCustomMeta(XmlOutputCustomMeta xmlOutputMeta) {
    ...
    XmlFieldCustom[] outputFields = xmlOutputMeta.getOutputFields();
    assertEquals(2, outputFields.length);

    assertEquals("fieldOne", outputFields[0].getFieldName());
    assertEquals(XmlFieldCustom.ContentType.Element, outputFields[0].getContentType());
  ...
  public void testClone() throws Exception {
    ...
    IHopMetadataProvider metadataProvider = mock(IHopMetadataProvider.class);
    xmlOutputMeta.loadXml(transformNode, metadataProvider);
    XmlOutputCustomMeta cloned = (XmlOutputCustomMeta) xmlOutputMeta.clone();
    assertNotSame(cloned, xmlOutputMeta);
    assertXmlOutputCustomMeta(cloned);
  }
  ...
  public void testGetFields() {
    XmlOutputCustomMeta xmlOutputMeta = new XmlOutputCustomMeta();
    xmlOutputMeta.setDefault();
    XmlFieldCustom xmlField = new XmlFieldCustom();
    xmlField.setFieldName("aField");
    xmlField.setLength(10);
    xmlField.setPrecision(3);
    xmlOutputMeta.setOutputFields(new XmlFieldCustom[] {xmlField});
  ...
  public void testGetRequiredFields() throws Exception {
    ...
    XmlFieldCustom xmlField2 = new XmlFieldCustom();
    xmlField2.setFieldName("bField");
    xmlField2.setType(3);
    xmlField2.setLength(4);
    xmlField2.setPrecision(5);
    xmlOutputMeta.setOutputFields(new XmlFieldCustom[] {xmlField, xmlField2});
