...
@Getter
@Setter
public class TextFileOutputCustomMeta
    extends BaseTransformMeta<TextFileOutputCustom, TextFileOutputCustomData> {
  ...
  public static class FileSettings {
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.FILENAME")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.DO_NOT_CREATE_FILE_AT_STARTUP")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.EXTENSION")
    ...
    @HopMetadataProperty(
        key = "append",
        injectionKey = "APPEND",
        injectionKeyDescription = "TextFileOutputCustom.Injection.APPEND")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.INC_TRANSFORMNR_IN_FILENAME")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.INC_PARTNR_IN_FILENAME")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.INC_DATE_IN_FILENAME")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.INC_TIME_IN_FILENAME")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.SPECIFY_DATE_FORMAT")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.DATE_FORMAT")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.ADD_TO_RESULT")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.RIGHT_PAD_FIELDS")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.FAST_DATA_DUMP")
    ...
    @HopMetadataProperty(
        ...
        injectionKeyDescription = "TextFileOutputCustom.Injection.SPLIT_EVERY")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.COMPRESSION")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.CREATE_PARENT_FOLDER")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.SEPARATOR")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.ENCLOSURE")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.FORCE_ENCLOSURE")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.DISABLE_ENCLOSURE_FIX")
  ...
  @HopMetadataProperty(
      key = "header",
      injectionKey = "HEADER",
      injectionKeyDescription = "TextFileOutputCustom.Injection.HEADER")
  ...
  @HopMetadataProperty(
      key = "footer",
      injectionKey = "FOOTER",
      injectionKeyDescription = "TextFileOutputCustom.Injection.FOOTER")
  private boolean footerEnabled;

  /**
   * The file format: DOS or Unix It could be injected using the key "FORMAT" see the setter {@link
   * TextFileOutputCustomMeta#setFileFormat(String)}.
   */
  @HopMetadataProperty(
      key = "format",
      injectionKey = "FORMAT",
      injectionKeyDescription = "TextFileOutputCustom.Injection.FORMAT")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.ENCODING")
  private String encoding;

  /** Write a UTF-8 byte order mark at the start of new UTF-8 output files. */
  @HopMetadataProperty(
      key = "add_utf8_bom",
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.ADD_ENDING_LINE")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.FILENAME_IN_FIELD")
  private boolean fileNameInField;

  @HopMetadataProperty(
      key = "fileNameField",
      injectionKey = "FILENAME_FIELD",
      injectionKeyDescription = "TextFileOutputCustom.Injection.FILENAME_FIELD")
  private String fileNameField;

  @HopMetadataProperty(
      key = "schema_definition",
      injectionKey = "SCHEMA_DEFINITION",
      injectionKeyDescription = "TextFileOutputCustom.Injection.SCHEMA_DEFINITION",
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.IGNORE_FIELDS")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_FIELD",
      injectionGroupDescription = "TextFileOutputCustom.Injection.OUTPUT_FIELDS")
  private List<TextFileOutputCustomField> outputFields;

  public TextFileOutputCustomMeta() {
    super();
  ...
  public TextFileOutputCustomMeta(TextFileOutputCustomMeta m) {
    ...
    m.outputFields.forEach(
        field -> {
          this.outputFields.add(new TextFileOutputCustomField(field));
        });
  }

  @Override
  public Object clone() {
    return new TextFileOutputCustomMeta(this);
  }
  ...
  public void getFields(
    ...
    for (TextFileOutputCustomField field : outputFields) {
  ...
  public void check(
    ...
    if (prev != null && !prev.isEmpty()) {
      cr =
          new CheckResult(
              ...
              BaseMessages.getString(
                  PKG, "TextFileOutputCustomMeta.CheckResult.FieldsReceived", "" + prev.size()),
              transformMeta);
      remarks.add(cr);
      ...
      for (TextFileOutputCustomField outputField : outputFields) {
      ...
      if (errorFound) {
        errorMessage =
            BaseMessages.getString(
                PKG, "TextFileOutputCustomMeta.CheckResult.FieldsNotFound", errorMessage);
        ...
        cr =
            new CheckResult(
                ICheckResult.TYPE_RESULT_OK,
                BaseMessages.getString(PKG, "TextFileOutputCustomMeta.CheckResult.AllFieldsFound"),
                transformMeta);
        remarks.add(cr);
      }
    }
    ...
    if (input.length > 0) {
      cr =
          new CheckResult(
              ICheckResult.TYPE_RESULT_OK,
              BaseMessages.getString(PKG, "TextFileOutputCustomMeta.CheckResult.ExpectedInputOk"),
              transformMeta);
      remarks.add(cr);
    } else {
      cr =
          new CheckResult(
              ...
              BaseMessages.getString(
                  PKG, "TextFileOutputCustomMeta.CheckResult.ExpectedInputError"),
              transformMeta);
      remarks.add(cr);
    }
    ...
    cr =
        new CheckResult(
            ...
            BaseMessages.getString(PKG, "TextFileOutputCustomMeta.CheckResult.FilesNotChecked"),
            transformMeta);
    remarks.add(cr);
  }
  ...
  protected String buildFilename(
      ...
      final boolean zipArchive,
      final boolean showSamples,
      final TextFileOutputCustomMeta meta) {
    return buildFilename(
        null,
        realFileName,
        realExtension,
