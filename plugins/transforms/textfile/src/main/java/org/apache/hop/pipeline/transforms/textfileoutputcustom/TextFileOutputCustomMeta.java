...
@InjectionSupported(
    localizationPrefix = "TextFileOutputCustom.Injection.",
...
public class TextFileOutputCustomMeta
  ...
  /** The output fields */
  @InjectionDeep private TextFileOutputCustomField[] outputFields;
   ...
   */
  public TextFileOutputCustomField[] getOutputFields() {
    return outputFields;
  }
   ...
   */
  public void setOutputFields(TextFileOutputCustomField[] outputFields) {
  ...
  public boolean isAddUtf8Bom() {
    return addUtf8Bom;
  }

  public void setAddUtf8Bom(boolean addUtf8Bom) {
  ...
  public void allocate(int nrFields) {
    outputFields = new TextFileOutputCustomField[nrFields];
  }

  @Override
  public Object clone() {
    TextFileOutputCustomMeta retval = (TextFileOutputCustomMeta) super.clone();
    int nrFields = outputFields.length;

    retval.allocate(nrFields);

    for (int i = 0; i < nrFields; i++) {
      retval.outputFields[i] = (TextFileOutputCustomField) outputFields[i].clone();
    }
  ...
  protected void readData(Node transformNode, IHopMetadataProvider metadataProvider)
    ...
    try {
      ...
      addUtf8Bom = "Y".equalsIgnoreCase(XmlHandler.getTagValue(transformNode, "add_utf8_bom"));
      ...
      for (int i = 0; i < nrFields; i++) {
        ...
        outputFields[i] = new TextFileOutputCustomField();
  ...
  public void getFields(
    ...
    for (int i = 0; i < outputFields.length; i++) {
      TextFileOutputCustomField field = outputFields[i];
  ...
  public String getXml() {
    ...
    retval.append("    ").append(XmlHandler.addTagValue("add_utf8_bom", addUtf8Bom));
