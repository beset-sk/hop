...
@Getter
@Setter
public class TextFileOutputCustomField implements Cloneable {
  @HopMetadataProperty(
      key = "name",
      injectionKey = "OUTPUT_FIELDNAME",
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_FIELDNAME")
  private String name;
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_TYPE")
  private int type;

  @HopMetadataProperty(
      key = "format",
      injectionKey = "OUTPUT_FORMAT",
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_FORMAT")
  private String format;

  @HopMetadataProperty(
      key = "length",
      injectionKey = "OUTPUT_LENGTH",
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_LENGTH")
  private int length = -1;

  @HopMetadataProperty(
      key = "precision",
      injectionKey = "OUTPUT_PRECISION",
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_PRECISION")
  private int precision = -1;

  @HopMetadataProperty(
      key = "currency",
      injectionKey = "OUTPUT_CURRENCY",
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_CURRENCY")
  private String currencySymbol;

  @HopMetadataProperty(
      key = "decimal",
      injectionKey = "OUTPUT_DECIMAL",
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_DECIMAL")
  private String decimalSymbol;

  @HopMetadataProperty(
      key = "group",
      injectionKey = "OUTPUT_GROUP",
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_GROUP")
  private String groupingSymbol;

  @HopMetadataProperty(
      key = "nullif",
      injectionKey = "OUTPUT_NULL",
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_NULL")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_TRIM")
  private int trimType;

  @HopMetadataProperty(
      key = "roundingType",
      injectionKey = "OUTPUT_ROUNDING",
      injectionKeyDescription = "TextFileOutputCustom.Injection.OUTPUT_ROUNDING")
  private String roundingType;

  public TextFileOutputCustomField() {
  ...
  public TextFileOutputCustomField(TextFileOutputCustomField f) {
    this();
  ...
  public int compare(Object obj) {
    TextFileOutputCustomField field = (TextFileOutputCustomField) obj;
  ...
  @Override
  public Object clone() {
    return new TextFileOutputCustomField(this);
  }
