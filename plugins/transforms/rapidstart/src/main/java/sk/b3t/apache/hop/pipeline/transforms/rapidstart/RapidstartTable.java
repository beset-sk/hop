...
public class RapidstartTable extends BaseTransform<RapidstartTableMeta, RapidstartTableData> {

  public RapidstartTable(
      TransformMeta transformMeta,
      RapidstartTableMeta meta,
      RapidstartTableData data,
      int copyNr,
