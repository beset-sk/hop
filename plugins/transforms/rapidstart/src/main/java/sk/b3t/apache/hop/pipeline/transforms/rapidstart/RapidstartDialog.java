...
public class RapidstartDialog extends BaseTransformDialog implements ITransformDialog {

  // Resource bundle marker pre BaseMessages
  private static final Class<?> PKG = RapidstartDialog.class;

  private final RapidstartMeta input;
  private Text wPackage;
  private Text wCode;

  public RapidstartDialog(
      Shell parent,
